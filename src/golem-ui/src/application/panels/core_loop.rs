...
fn core_loop<C, E: Debug>(
    ...
    core: &mut GolemCore,
    context: &mut C,
    mut shortcut_handler: impl FnMut(&mut GoLEmApp, &mut GolemCore, CommandId, &mut C) -> Result<(), E>,
...
pub fn run_core_loop<C, E: Debug>(
    ...
    core: &mut GolemCore,
    context: &mut C,
    shortcut_handler: impl FnMut(&mut GoLEmApp, &mut GolemCore, CommandId, &mut C) -> Result<(), E>,
