...
#[cfg(not(feature = "platform_de10"))]
pub fn fpga_spi(_word: u16) -> u16 {
    0
}

#[cfg(not(feature = "platform_de10"))]
pub fn fpga_spi_en(_mask: u32, _en: u32) {}

#[cfg(not(feature = "platform_de10"))]
pub fn is_fpga_ready(_quick: c_int) -> c_int {
    1
}
...
#[cfg(not(feature = "platform_de10"))]
pub fn fpga_load_rbf(_name: *const c_char, _cfg: *const c_char, _xml: *const c_char) -> c_int {
    1
}
